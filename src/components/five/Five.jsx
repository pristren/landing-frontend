...
export default function Five() {
  return (
    <section className="py-20 px-10 lg:px-0 z-50">
        ...
        <div className="md:pl-[50%] p-5 pt-[5%] flex items-center justify-center">
          <div>
            ...
            <h2 className="text-white font-bold text-3xl">
              HappyVecinos nos ha unido, facilitando la gestión y mejorando la
              comunicación en nuestra comunidad{" "}
            </h2>
            <p className="text-white mt-4">orge Gómez</p>
            <p className="text-[#92c5fd] font-medium">
              Presidente de la Comunidad Los Pinos
            </p>
          </div>
        </div>
        {/* img  */}
